...
http://cartodb.github.io/odyssey.js/examples/sports/dist/?vis=628c2b32-9ae7-11e4-b88e-0e4fddd5de28&user=matallo&table_name=ohio_state_vs_oregon&t=Ohio%20State,F11810%7COregon,229A00
...
- **name** 
The kind of event: `substitution, yellow, score, football, red or slide`

In case of a football match the `name` will be "football". In case of a soccer match the `name` will be "score".

- **description** 
The content in the chapter slide (for _slide_ events). It supports Markdown.

Also, it's used as the score for every team.
...
- **visible** 
Visibility of the event in the timeline (`true or false`). _Slide_ event will still occur even if they won't appear in the timeline. 
...
```
&user=matallo&table_name=ohio_state_vs_oregon
```
